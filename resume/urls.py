...
from views import create_resume_view, ResumeView, ResumePublicView, ResumePDFView, delete_resume_view
...
urlpatterns = patterns(
    ...
    url(r'^(?P<pk>\d+)/pdf$', ResumePDFView.as_view(), name='resume.pdf'),
