...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'resume_resumeitem', 'value', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'ResumeItem.value'
        db.alter_column(u'resume_resumeitem', 'value', self.gf('django.db.models.fields.CharField')(max_length=100))
