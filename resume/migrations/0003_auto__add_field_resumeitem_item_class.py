...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResumeItem.item_class'
        db.add_column(u'resume_resumeitem', 'item_class',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResumeItem.item_class'
        db.delete_column(u'resume_resumeitem', 'item_class')
