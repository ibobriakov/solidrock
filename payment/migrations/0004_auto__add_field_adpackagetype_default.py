...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdPackageType.default'
        db.add_column(u'payment_adpackagetype', 'default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdPackageType.default'
        db.delete_column(u'payment_adpackagetype', 'default')
