...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdPackageHistory'
        db.create_table(u'payment_adpackagehistory', (
        ...
        db.send_create_signal(u'payment', ['AdPackageHistory'])

        # Adding model 'AdPackageType'
        db.create_table(u'payment_adpackagetype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('ad_count', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('cost', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('promo', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'payment', ['AdPackageType'])

        # Adding model 'SubscriptionType'
        db.create_table(u'payment_subscriptiontype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('prolongation', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('cost', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('promo', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'payment', ['SubscriptionType'])
    ...
    def backwards(self, orm):
        # Deleting model 'AdPackageHistory'
        db.delete_table(u'payment_adpackagehistory')

        # Deleting model 'AdPackageType'
        db.delete_table(u'payment_adpackagetype')

        # Deleting model 'SubscriptionType'
        db.delete_table(u'payment_subscriptiontype')
