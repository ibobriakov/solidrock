...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Employer.address_first'
        db.add_column(u'userprofile_employer', 'address_first',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employer.address_second'
        db.add_column(u'userprofile_employer', 'address_second',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employer.city'
        db.add_column(u'userprofile_employer', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employer.postcode'
        db.add_column(u'userprofile_employer', 'postcode',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employer.abn_or_acn'
        db.add_column(u'userprofile_employer', 'abn_or_acn',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employer.business_phone'
        db.add_column(u'userprofile_employer', 'business_phone',
                      self.gf('userprofile.models.fields.PhoneField')(default='00000000000', max_length=11, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employer.brief'
        db.add_column(u'userprofile_employer', 'brief',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employer.name'
        db.add_column(u'userprofile_employer', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employer.email'
        db.add_column(u'userprofile_employer', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employer.agree'
        db.add_column(u'userprofile_employer', 'agree',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Employer.address_first'
        db.delete_column(u'userprofile_employer', 'address_first')

        # Deleting field 'Employer.address_second'
        db.delete_column(u'userprofile_employer', 'address_second')

        # Deleting field 'Employer.city'
        db.delete_column(u'userprofile_employer', 'city')

        # Deleting field 'Employer.postcode'
        db.delete_column(u'userprofile_employer', 'postcode')

        # Deleting field 'Employer.abn_or_acn'
        db.delete_column(u'userprofile_employer', 'abn_or_acn')

        # Deleting field 'Employer.business_phone'
        db.delete_column(u'userprofile_employer', 'business_phone')

        # Deleting field 'Employer.brief'
        db.delete_column(u'userprofile_employer', 'brief')

        # Deleting field 'Employer.name'
        db.delete_column(u'userprofile_employer', 'name')

        # Deleting field 'Employer.email'
        db.delete_column(u'userprofile_employer', 'email')

        # Deleting field 'Employer.agree'
        db.delete_column(u'userprofile_employer', 'agree')
