...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobSeekerEducation.value'
        db.alter_column(u'userprofile_jobseekereducation', 'value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'JobSeekerEducation.value'
        raise RuntimeError("Cannot reverse this migration. 'JobSeekerEducation.value' and its values cannot be restored.")
