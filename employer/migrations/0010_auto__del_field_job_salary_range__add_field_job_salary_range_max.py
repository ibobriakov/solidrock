...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Job.salary_range'
        db.delete_column(u'employer_job', 'salary_range_id')

        # Adding field 'Job.salary_range_max'
        db.add_column(u'employer_job', 'salary_range_max',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Job.salary_range'
        db.add_column(u'employer_job', 'salary_range',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employer.SalaryRange'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Job.salary_range_max'
        db.delete_column(u'employer_job', 'salary_range_max')
    ...
    models = {
        ...
        u'employer.job': {
            ...
            'salary_range_max': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
