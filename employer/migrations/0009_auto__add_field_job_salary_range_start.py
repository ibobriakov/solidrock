...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.salary_range_start'
        db.add_column(u'employer_job', 'salary_range_start',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.salary_range_start'
        db.delete_column(u'employer_job', 'salary_range_start')
    ...
    models = {
        ...
        u'employer.job': {
            ...
            'salary_range_start': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
