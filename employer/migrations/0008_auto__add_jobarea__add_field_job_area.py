...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.area'
        db.add_column(u'employer_job', 'area',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employer.JobArea'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Job.area'
        db.delete_column(u'employer_job', 'area_id')
