...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.contact_email'
        db.alter_column(u'employer_job', 'contact_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Job.contact_email'
        raise RuntimeError("Cannot reverse this migration. 'Job.contact_email' and its values cannot be restored.")
