...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'employer.job': {
            ...
            'sub_categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['employer.JobSubCategory']", 'null': 'True', 'through': u"orm['employer.JobSelectedCategory']", 'blank': 'True'}),
