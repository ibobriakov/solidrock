...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CoverLetterItem.item_class'
        db.add_column(u'cover_letter_coverletteritem', 'item_class',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


        # Changing field 'CoverLetterItem.value'
        db.alter_column(u'cover_letter_coverletteritem', 'value', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting field 'CoverLetterItem.item_class'
        db.delete_column(u'cover_letter_coverletteritem', 'item_class')


        # Changing field 'CoverLetterItem.value'
        db.alter_column(u'cover_letter_coverletteritem', 'value', self.gf('django.db.models.fields.CharField')(max_length=100))
