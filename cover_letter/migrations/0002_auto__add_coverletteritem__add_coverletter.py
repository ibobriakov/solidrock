...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CoverLetter'
        db.create_table(u'cover_letter_coverletter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'cover_letter', ['CoverLetter'])


    def backwards(self, orm):
        # Deleting model 'CoverLetterItem'
        db.delete_table(u'cover_letter_coverletteritem')

        # Deleting model 'CoverLetter'
        db.delete_table(u'cover_letter_coverletter')
