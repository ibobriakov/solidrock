...
from main.api import ResourceTypesOverrideSchemaMixin, ResourceLabelSchemaMixin, ResourceFieldsOrderSchemaMixin
...
class RegistrationResource(ResourceFieldsOrderSchemaMixin, ResourceLabelSchemaMixin,
