    ...
    return {
        ...
        link: function (scope, element) {
            ...
            if (scope.data.type.split('_')[1] == 'list') {
                ...
                template += '<div noteditable="true" ng-class="{outline: data.type == \'text\'}" class="paper {[{ data.type }]} {[{ data.item_class }]}" ng-model="data.value"></div>'
            }
